...
class SourceAndOutput:
    ...
    def _build_select_dc_button(self):
        self.select_data_cube_button = make_button(self.root, text="Select Data Cube", command=self.__set_data_cube, inner_padx=10, inner_pady=10, outer_padx=10, outer_pady=0, row=1, column=0, width=15)
