...
class NewColourData:
    ...
    def _build_data(self):
        ...
        self.sd_text = make_text(self.root, content="SD = " + str(self.sd_value), bg=tkcolour_from_rgb(BACKGROUND),
                                 column=0, row=2, width=25, columnspan=2, padx=(20, 15), state=NORMAL)
        # median
