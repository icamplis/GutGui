...
class Introduction:
    def __init__(self, introduction_frame):
        ...
        self.urls = ['http://diaspective-vision.com', 'https://github.com/icamplis/GutGui']
        ...
        self.text_text_3c = "github.com/icamplis/GutGui."
        ...
        self.image_4b = "Both formulas used by the software to calculate the four index pictures. The left formula is " \
                        "used for StO2, the right formula is used for NIR, THI, and TWI with the different wavelength" \
                        "areas specified in Figure 6. The letter variables 'r' and 's' cannot be provided."
    ...
    def _build_page3(self):
        ...
        image_text1.tag_config('tit', foreground='black')
        image_text1.grid(padx=(0, 25), pady=(50, 0), row=0, column=1)
        image_text1.config(state=DISABLED)
        image_text2 = Text(self.root, height=2, width=100, wrap=WORD, highlightthickness=0,
                          foreground=tkcolour_from_rgb(GREY))
        ...
        image_text2.tag_config('tit', foreground='black')
        image_text2.config(state=DISABLED)
        image_text2.grid(padx=(0, 25), pady=(630, 15), row=0, column=1)
    ...
    def _build_page4(self):
        ...
        image_text1 = Text(self.root, height=3, width=100, wrap=WORD, highlightthickness=0,
                          foreground=tkcolour_from_rgb(GREY))
        image_text1.insert(END, 'Figure 6', ('tit', str(2)))
        image_text1.insert(END, ' | ' + self.image_4a)
        image_text1.tag_config('tit', foreground='black')
        image_text1.grid(padx=(0, 25), pady=(150, 0), row=0, column=1)
        image_text1.config(state=DISABLED)
        image_text2 = Text(self.root, height=4, width=100, wrap=WORD, highlightthickness=0,
                          foreground=tkcolour_from_rgb(GREY))
        image_text2.insert(END, 'Figure 7', ('tit', str(3)))
        image_text2.insert(END, ' | ' + self.image_4b)
        image_text2.tag_config('tit', foreground='black')
        image_text2.config(state=DISABLED)
        image_text2.grid(padx=(0, 25), pady=(600, 15), row=0, column=1)

    def _build_page5(self):
        # text
        text = Text(self.root, height=6, width=150, wrap=WORD, highlightthickness=0, foreground=tkcolour_from_rgb(GREY))
